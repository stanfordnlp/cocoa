def add_data_generator_arguments(parser):
    ...
    from cocoa.basic.negotiation.price_tracker import add_price_tracker_arguments
    from cocoa.basic.negotiation.slot_detector import add_slot_detector_arguments
...
def get_data_generator(args, model_args, mappings, schema):
    ...
    from cocoa.basic.negotiation.slot_detector import SlotDetector
    from cocoa.basic.dataset import read_dataset, EvalExample
